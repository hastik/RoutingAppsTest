...
function attachGlobalHandlers(sidebarLinks, logoutButton, sidebarToggle) {
...
export async function loadLayout() {
  ...
  attachGlobalHandlers(refs.sidebarLinks, refs.logoutButton, refs.sidebarToggle);

  const rootContainer = document.createElement('div');
  rootContainer.id = 'react-root';
